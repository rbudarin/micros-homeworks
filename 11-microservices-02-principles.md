...
|  Возможности  |  Apache ActiveMQ  |  Apache Kafka  |  RabbitMQ  |  NATS  |
|---------------|-------------------|----------------|------------|--------|
| Кластеризация для надёжности | Да | Да | Да | Да |
| Хранение сообщений на диске | Да | Да	| Да | Опционально |
| Высокая скорость работы | Средняя | Очень высокая | Высокая |	Очень высокая |
| Поддержка различных форматов сообщений | Да | Ограниченная | Да | Ограниченная |
...
RabbitMQ - Сочетает в себе надёжность, функциональность и относительную простоту в эксплуатации
